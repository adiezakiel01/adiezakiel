  ...
  return (
    <section id="about" className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={contentRef} className=" reveal grid sm:grid-cols-2 gap-8">
          <div>
            <p className="text-gray-400 leading-relaxed mb-4">
              I&apos;m a Bachelor of IT graduate from Curtin Singapore with a
              passion for building full-stack applications that combine clean
              engineering with AI capabilities.
            </p>
            <p className="text-gray-400 leading-relaxed mb-4">
              My background started with Django and MySQL in my capstone BI
              dashboard. I&apos;ve since expanded into async Python with
              FastAPI, PostgreSQL, Docker, TypeScript, and AI integration using
              LangChain and local LLMs.
            </p>
            <p className="text-gray-400 leading-relaxed">
              I enjoy working at the intersection of data engineering and AI,
              building systems that turn raw data into actionable insights.
            </p>
          </div>
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                text: "Bachelor of Information Technology, Curtin Singapore",
              },
              {
                icon: (
                  <svg
                ...
                text: "Open to full-stack & AI engineering roles",
              },
              {
                icon: (
                  <svg
                ...
                text: "Pour-over coffee enthusiast",
              },
            ].map((item) => (
